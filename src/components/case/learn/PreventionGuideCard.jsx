  ...
  return (
    <div className="bg-[#161616] border border-white/10 rounded-2xl p-6 flex flex-col gap-4 h-full">
      ...
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-full bg-[#1a3a2a] border border-green-500/40 flex items-center justify-center shrink-0">  
          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-green-400" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">  
      ...
      <ul className="flex flex-col gap-3 flex-1">
        {items.map((item, idx) => (  
          <li key={item.id ?? idx} className="flex items-start gap-3">  
            <span className="mt-1.5 w-2 h-2 rounded-full bg-[#e5341a] shrink-0" />  

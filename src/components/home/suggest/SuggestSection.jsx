...
const SuggestSection = ({ caseData }) => {
    ...
    return (
        <section className="py-12 px-4 max-w-6xl mx-auto">
            ...
            <div className="relative group overflow-hidden rounded-2xl bg-[#121212] border border-zinc-800 flex flex-col md:flex-row gap-8 p-6 transition-all hover:border-zinc-700">
